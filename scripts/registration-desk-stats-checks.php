...
oras_stats_assert( 6 === $stats['today']['actual_people'], 'Today counts actual checked-in people, not registrations' );
oras_stats_assert( 2 === $stats['today']['website_people'] && 1 === $stats['today']['walk_in_people'] && 1 === $stats['today']['complimentary_people'] && 1 === $stats['today']['rsvp_people'] && 1 === $stats['today']['manager_verified_people'], 'Today source split follows each attendee registration honestly' );
...
oras_stats_assert( 6 === $stats['event_total']['active_registrations'], 'Event total counts registrations separately' );
oras_stats_assert( 6 === $stats['event_total']['unique_attendees'], 'Unique event attendance de-duplicates multi-day people' );
oras_stats_assert( 7 === $stats['event_total']['attendance_instances'], 'Attendance instances include every checked-in day' );
