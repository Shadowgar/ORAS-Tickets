...
oras_qbo_fixture_run_with_cleanup(
	static function (): void {
		...
		$processing_order = oras_qbo_fixture_track_order( wc_create_order() );
		...
		$old_order = oras_qbo_fixture_track_order( wc_create_order() );
		...
		$synced_order = oras_qbo_fixture_track_order( wc_create_order() );
