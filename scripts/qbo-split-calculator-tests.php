...
oras_qbo_fixture_run_with_cleanup(
	static function () use ( $split_calculator ): void {
		...
		$observer_product_id = (int) $observer_product->save();
		oras_qbo_fixture_track_product( $observer_product_id );
		...
		$merch_product_id = (int) $merch_product->save();
		oras_qbo_fixture_track_product( $merch_product_id );
