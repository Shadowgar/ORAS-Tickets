...
oras_qbo_fixture_run_with_cleanup(
	static function (): void {
		...
		oras_qbo_fixture_track_product( $fixture_product );
		...
		$order_synced = oras_qbo_fixture_track_order( wc_create_order() );
		...
		$order_unsynced = oras_qbo_fixture_track_order( wc_create_order() );
		...
		$order_reversed = oras_qbo_fixture_track_order( wc_create_order() );
