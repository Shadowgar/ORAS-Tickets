...
final class Event_Agenda_Metabox // NOSONAR legacy WP class naming
{
            ...
            <div id="oras-agenda-days">
                <?php foreach ($days as $day_index => $day) : ?>
                    ...
                    <div class="oras-agenda-day" data-day-index="<?php echo esc_attr((string) $day_index); ?>" style="margin:16px 0;padding:12px;border:1px solid #ddd;">
                        ...
                        <p>
                            <span class="oras-field-label"><strong><?php echo esc_html__('Date', 'oras-tickets'); ?></strong></span><br />
                                                ...
                                                <div class="oras-agenda-resources-rows" style="margin-top:6px;">
                                                    ...
                                                    ?>
                                                        <div class="oras-agenda-resource-row" data-resource-index="<?php echo esc_attr((string) $resource_index); ?>" style="margin:6px 0;padding:6px;border:1px solid #ddd;">
                                                            ...
                                                            <p>
                                                                <span class="oras-field-label"><?php echo esc_html__('External URL', 'oras-tickets'); ?></span><br />
                                                            ...
                                                            <p>
                                                                <span class="oras-field-label"><?php echo esc_html__('Label', 'oras-tickets'); ?></span><br />
                                                            ...
                                                            <p>
                                                                <span class="oras-field-label"><?php echo esc_html__('Associated Speakers', 'oras-tickets'); ?></span><br />
            ...
            (function() {
                ...
                function resourceRowHtml(dayIndex, slotIndex, resourceIndex) {
                    return '' +
                        ...
                        '<p><span class="oras-field-label"><?php echo esc_js(__('External URL', 'oras-tickets')); ?></span><br />' +
                        '<input type="url" class="widefat" name="oras_agenda[days][' + dayIndex + '][slots][' + slotIndex + '][resources][' + resourceIndex + '][url]" value="" /></p>' +
                        '<p><span class="oras-field-label"><?php echo esc_js(__('Label', 'oras-tickets')); ?></span><br />' +
                        '<input type="text" class="widefat" name="oras_agenda[days][' + dayIndex + '][slots][' + slotIndex + '][resources][' + resourceIndex + '][label]" value="" /></p>' +
                        '<p><span class="oras-field-label"><?php echo esc_js(__('Type', 'oras-tickets')); ?></span><br />' +
                        ...
                        '</select></p>' +
                        '<p><span class="oras-field-label"><?php echo esc_js(__('Visibility', 'oras-tickets')); ?></span><br />' +
