...
final class Speaker_CPT { // NOSONAR legacy WP class naming
    ...
    public function register(): void {
        ...
        add_action( 'save_post_' . self::POST_TYPE, array( $this, 'sync_headshot_meta' ), 20 );
    }
    ...
    public function register_metabox(): void {
        ...
        add_meta_box(
            ...
            array( $this, 'render_history_metabox' ),
            self::POST_TYPE,
            'normal',
            'default'
        );
