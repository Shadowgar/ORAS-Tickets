...
final class Reports_Page { // NOSONAR legacy WP class naming
    ...
    <div class="wrap oras-tickets-reports">
        ...
        <div class="oras-card">
            ...
            <table class="widefat striped oras-table">
                <th scope="col"ead>
                <tr>
                    <th scope="col"><?php echo esc_html__( 'Event', 'oras-tickets' ); ?></th>
                    <th scope="col"><?php echo esc_html__( 'Event date', 'oras-tickets' ); ?></th>
                    <th scope="col"><?php echo esc_html__( 'Orders', 'oras-tickets' ); ?></th>
                    <th scope="col"><?php echo esc_html__( 'Tickets sold', 'oras-tickets' ); ?></th>
        ...
        <?php else : ?>
            ...
            <table class="widefat striped oras-table">
                <th scope="col"ead>
                <tr>
                    <th scope="col"><?php echo esc_html__( 'Ticket', 'oras-tickets' ); ?></th>
                    <th scope="col"><?php echo esc_html__( 'Sold qty', 'oras-tickets' ); ?></th>
                    <th scope="col" class="is-right"><?php echo esc_html__( 'Gross', 'oras-tickets' ); ?></th>
                    <th scope="col"><?php echo esc_html__( 'Refunded qty', 'oras-tickets' ); ?></th>
                    <th scope="col" class="is-right"><?php echo esc_html__( 'Refunded amount', 'oras-tickets' ); ?></th>
                    <th scope="col" class="is-right"><?php echo esc_html__( 'Net', 'oras-tickets' ); ?></th>
                </tr>
                </thead>
                <tbody>
                ...
                <tfoot>
                    ...
                    <th scope="col" class="is-right"><?php echo esc_html( $this->format_money( $aggregates['summary']['net_sales'] ) ); ?></th>
                    </tr>
                </tfoot>
                <?php endif; ?>
            </table>
...
if ( $b === '' ) {
                ...
                <table class="widefat striped oras-table">
                    <th scope="col"ead>
                    <tr>
                        <th scope="col"><?php echo esc_html__( 'Phase', 'oras-tickets' ); ?></th>
                        <th scope="col"><?php echo esc_html__( 'Qty', 'oras-tickets' ); ?></th>
                        <th scope="col" class="is-right"><?php echo esc_html__( 'Unit price', 'oras-tickets' ); ?></th>
                        <th scope="col" class="is-right"><?php echo esc_html__( 'Gross', 'oras-tickets' ); ?></th>
                    </tr>
                    </thead>
                    <tbody>
