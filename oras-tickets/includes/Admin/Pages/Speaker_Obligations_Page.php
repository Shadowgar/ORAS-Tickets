...
final class Speaker_Obligations_Page // NOSONAR legacy WP class naming
{
    ...
    {
        add_action('admin_post_oras_speaker_fulfill_membership', array($this, 'handle_fulfill_membership'));
    }
    ...
    private function get_obligation_rows(array $filters): array
    {
        ...
        foreach ($events as $event) {
            ...
            foreach ($assignments as $assignment_index => $assignment) {
                ...
                if (! in_array($compensation_type, array('fee', 'membership'), true)) {
                    continue;
                }
